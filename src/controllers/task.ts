...
export const createTask: any = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(201).json({
      ...
      task,
      message:
        "Task created, assigned successfully, and email notifications sent to both users.",
    });
  } catch (error: any) {
...
export const getAllTasks:any = async (req: Request, res: Response) => {
  try {
...
export const getTaskById:any = async (req: Request, res: Response) => {
  try {
...
export const updateTask:any = async (req: Request, res: Response) => {
  try {
    const { id } = req.params; // Get the task ID from request parameters
...
export const deleteTask:any = async (req: Request, res: Response) => {
  try {
    const { id } = req.params; // Get the task ID from request parameters
