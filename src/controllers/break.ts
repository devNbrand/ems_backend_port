...
// Create a new break
export const startBreak:any = async (req:Request, res:Response) => {
  try {
...
// End a break
export const endBreak:any = async (req:Request, res:Response) => {
  try {
    const userId = req.user.id; // Get the user ID from the authenticated user
    ...
    const breakRecord:any = await prisma.break.findUnique({
...
export const getUserBreaks:any = async (req:Request, res:Response) => {
  try {
    const userId = req.user.id; // Get the user ID from the authenticated user
